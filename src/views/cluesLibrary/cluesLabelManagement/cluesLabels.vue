    ...
    <div>
        ...
        <Modal
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="70">
                ...
                <FormItem label="标签类型" prop="labeltype">
                    <Select v-model="formValidate.labeltype" style="width:200px">
        ...
        <Modal
            ...
            <Form ref="formValidate2" :model="formValidate2" :label-width="70">
                ...
                <FormItem label="标签类型" prop="labeltype">
                    <Select v-model="formValidate2.labeltype" style="width:200px" disabled>
                        <Option value="shangshilei">商事类</Option>
                        <Option value="kuaijilei">会计类</Option>
                        <Option value="qihualei">企划类</Option>
                        <Option value="shenjilei">审计类</Option>
        ...
        <Modal
            ...
            <Form ref="formValidate3" :model="formValidate3" :label-width="70">
                ...
                <FormItem label="标签类型" prop="labeltype">
                    <Select v-model="formValidate3.labeltype" style="width:200px">
                        <Option value="shangshilei">商事类</Option>
                        <Option value="kuaijilei">会计类</Option>
                        <Option value="qihualei">企划类</Option>
                        <Option value="shenjilei">审计类</Option>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTableData() {
                let _self = this
                let url = '/label/findAllLabelByPages/1/10'
            ...
            pageChange(a) {
                let _self = this
                let url = '/label/findAllLabelByPages/' + a + '/' + _self.pageSize
            ...
            pageSizeChange(a) {
                let _self = this
                let url = '/label/findAllLabelByPages/1/' + a
                _self.pageSize = a
                _self.data = []
            ...
            detail(e) {
                let _self = this
                let url = '/label/findLabelById/' + e.row.id
                _self.modal2 = true

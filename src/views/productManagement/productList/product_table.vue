                ...
                <TabPane label="基本信息" name="name1">
                    <Form ref="formValidate" :model="formValidate" :rules="Addrule" :label-width="120">
                        ...
                        <FormItem label="是否为周期性产品" prop="iscycle">
                            <Select v-model="formValidate.iscycle">
                                <Option value="Y">是</Option>
                                <Option value="N">否</Option>
                            </Select>
                        </FormItem>
                        <FormItem label="默认服务部门" prop="defaultdepartalias">
                            <Select v-model="formValidate.defaultdepartalias">
                        ...
                        <FormItem v-for="item in addPropertyData" :label="item.text">
                            <CheckboxGroup v-model="PropertySelectedData" @on-change="PropertyChange(item.id)">
                                <Checkbox v-for="items in item.children" :label="items.id">{{ items.text }}</Checkbox>
                            </CheckboxGroup>
                        </FormItem>
                    </Form>
                </TabPane>
            ...
            <Tabs value="name1">
                <TabPane label="基本信息" name="name1">
                    <Form ref="formValidate2" :model="formValidate2" :rules="Editrule" :label-width="120">
                        ...
                        <FormItem label="是否为周期性产品" prop="iscycle">
                            <Select v-model="formValidate2.iscycle">
                                <Option value="Y">是</Option>
                                <Option value="N">否</Option>
                            </Select>
                        </FormItem>
                        <FormItem label="默认服务部门" prop="defaultdepartalias">
                            <Select v-model="formValidate2.defaultdepartalias">
                                <Option v-for="item in departValue" :value="item.value" :key="item.value">{{ item.label
                                    }}
                                </Option>
                            </Select>
                        ...
                        <FormItem v-for="item in addPropertyData2" :label="item.name">
                            <CheckboxGroup v-model="PropertySelectedData3" @on-change="PropertyChange2(item.id)">
                                <Checkbox v-for="items in item.children" :label="items.pvId">{{ items.propertyValue }}
                                </Checkbox>
                            </CheckboxGroup>
                        </FormItem>
                    </Form>
            ...
            <Tabs value="name1">
                <TabPane label="基本信息" name="name1">
                    <Form ref="formValidate3" :model="formValidate3" :label-width="120">
                        ...
                        <FormItem label="是否为周期性产品" prop="iscycle" >
                            <Select v-model="formValidate3.iscycle" disabled>
                                <Option value="Y">是</Option>
                                <Option value="N">否</Option>
                            </Select>
                        </FormItem>
                        <FormItem label="默认服务部门" prop="defaultdepartalias">
                            <Select v-model="formValidate3.defaultdepartalias" disabled>
                                <Option v-for="item in departValue" :value="item.value" :key="item.value">{{ item.label
                                    }}
                                </Option>
                            </Select>
                        ...
                        <FormItem v-for="item in addPropertyData3" :label="item.name">
                            <CheckboxGroup v-model="PropertySelectedData4" @on-change="PropertyChange(item.id)">
                                <Checkbox v-for="items in item.children" :label="items.pvId"  disabled>{{ items.propertyValue }}
                                </Checkbox>
                            </CheckboxGroup>
                        </FormItem>
                    </Form>

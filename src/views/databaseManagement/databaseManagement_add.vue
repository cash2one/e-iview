            ...
            <Form ref="formValidate" :model="formValidate" :label-width="80">
                ...
                <Row :gutter="16">
                    ...
                    <FormItem label="数据库模板" prop="sqlCatalog">
                        <Select v-model="formValidate.sqlCatalog">
                ...
                <Row :gutter="16">
                    ...
                    <FormItem label="sql类型" prop="sqlType">
                        <Select v-model="formValidate.sqlType">
                            ...
                            <Panel name="1">
                                ...
                                <table class="edit-table">
                                    ...
                                    <tr v-for="item in tableData">
                                        ...
                                        <td>
                                            <Select v-model="item.ruleValueType" @on-change="addCell(item.ruleIndex)">
                                        ...
                                        <td>
                                            <Select v-model="item.ruleCondition" @on-change="addCell(item.ruleIndex)">
                                                <Option value="=">=</Option>
                                        ...
                                        <td>
                                            <Select v-model="item.sysFlag" @on-change="addCell(item.ruleIndex)">

    ...
    <div>
       <!-- <Button type="ghost" shape="circle" icon="plus" @click="getSelectOptons();modal33 = true">新增</Button>-->
        <Timeline style="margin-top: 15px">
            <TimelineItem color="blue" v-for="item in items">
                ...
                <Card>
                    ...
                    <Row v-if="(item.imgurls) &amp;&amp; (item.serviceId == b.serviceId)" v-for="b in bb">
                    ...
                    <Div v-if="(item.followType == '11') || (item.followType == '12') || (item.followType == '13')">
                        ...
                        <Div style="display: none" :id="item.serviceId">
                            <Div :id="item.bussinessId">
                                <Row>
                                    <Div class="bubbleItem" style="font-size: 10px" v-for="chat in chats"
                    ...
                    <Row>
                        <div style="float: right">
                            <Button type="primary" shape="circle" v-for="item2 in itemss"
                                    v-if="(item2.buttonsZt == '0') && (item.serviceId == item2.serviceId)">
                                {{ item2.buttonText }}
                            </Button>
                            <Button disabled shape="circle" v-for="item2 in itemss"
            ...
            <Form ref="formValidate" :rules="ruleValidate" :model="formValidate" :label-width="80">
                <Row :gutter="16">
                    ...
                    <FormItem label="跟进类型" prop="followUpType">
                        <Select v-model="formValidate.followUpType" size="small">
    ...
    export default {
        ...
        methods: {
            ...
            openEdi() {
                ...
                _self.chats = []
                _self.items = []
                var url = '/customer/findCustomerContentById/' + _self.customerid

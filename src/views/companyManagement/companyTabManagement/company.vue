                ...
                <Card>
                    <Collapse @on-change="collapseChange" accordion>
                        ...
                        <Panel name="CustomerContent">
                            客户跟进记录
                            <P slot="content">
                                <!-- <edit-collapse-follow-up v-if="isEdit"   :customerid='customerid'></edit-collapse-follow-up> -->
                            </P>
                        </Panel>
                        <Panel name="Order">
                            订单详情
                            <P slot="content">
                                ...
                                <!-- <edit-collapse-order-list v-if="isEdit" :customerid='customerid'></edit-collapse-order-list> -->
                            </P>
                        </Panel>
                        <Panel name="CustomerRelation">
                            客户关系人
                            <P slot="content">
                                <!-- <edit-collapse-relation-person v-if="isEdit" :customerid='customerid'></edit-collapse-relation-person> -->
                            </P>
                        </Panel>
                        <Panel name="CustomerWorkOrder">
                            服务动态
                            <P slot="content">
                                <!-- <edit-collapse-service-dynamic v-if="isEdit" :customerid='customerid'></edit-collapse-service-dynamic> -->
                            </P>
                        </Panel>
                        <Panel name="FilesUpload">
                            ...
                            <P slot="content">
                                ...
                                <!-- <edit-collapse-upload ref="c1" v-if="isEdit" :customerid='customerid':modal3="modal3"></edit-collapse-upload> -->
                            </P>
                        </Panel>
                    </Collapse>
                </Card>
...
<script>
    ...
    import editTable from './companyTable.vue'
